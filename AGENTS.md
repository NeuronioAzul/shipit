...
Guia para o Codex trabalhar neste projeto. Este arquivo é carregado automaticamente em toda sessão — ele resume **o essencial e as regras que não podem ser quebradas**. Para o panorama técnico completo (IPC, entidades, rotas, temas, decisões), veja [docs/ARCHITECTURE.md](<docs/ARCHITECTURE.md>).
