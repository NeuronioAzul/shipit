...
| Pacote                   | Versão   | Finalidade                                                        |
| ------------------------ | -------- | ----------------------------------------------------------------- |
| `@playwright/test`       | 1.59.1   | Framework de testes E2E para Electron (41 cenários em `e2e/app.spec.ts` + `e2e/legacy-schema-guard.spec.ts`). |
...
Playwright   →  Testes E2E (41 cenários)
```
