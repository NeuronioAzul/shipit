...
| Pacote                   | Versão   | Finalidade                                                        |
| ------------------------ | -------- | ----------------------------------------------------------------- |
| `@playwright/test`       | 1.59.1   | Framework de testes E2E para Electron (45 cenários em `e2e/app.spec.ts` + `e2e/legacy-schema-guard.spec.ts`). |
...
| `vitest`                 | 4.1.3    | Test runner rápido compatível com Vite (275 testes verificados em 15/09/2026). |
...
Vitest       →  Testes unitários e integração (275 testes verificados em 15/09/2026)
Playwright   →  Testes E2E (45 cenários)
```
